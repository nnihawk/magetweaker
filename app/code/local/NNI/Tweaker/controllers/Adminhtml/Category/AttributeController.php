...
class NNI_Tweaker_Adminhtml_Category_AttributeController extends Mage_Adminhtml_Controller_Action// Mage_Adminhtml_Catalog_Product_AttributeController
{
    protected function _initAction()
    {
        ...
        if ($this->getRequest()->getParam('popup')) {
            ...
            $this->loadLayout()
                ...
                ->_addBreadcrumb(
                    Mage::helper('catalog')->__('Manage Catalog Attributes'),
                    Mage::helper('catalog')->__('Manage Catalog Attributes')
                )
            ;
        }
    ...
    public function indexAction()
    {
       $this->_initAction();
        ...
        $this->getLayout()->getBlock('content')
            ->append($this->getLayout()->createBlock('nni_tweaker/adminhtml_catalog_category_attribute'));
         $this->renderLayout();
    }
    ...
    public function editAction()
    {
        ...
        $this->getLayout()->getBlock('left')
            ->append($this->getLayout()->createBlock('adminhtml/catalog_product_attribute_edit_tabs','attribute_edit_tabs'));
        $this->getLayout()->getBlock('content')
            ->append($this->getLayout()->createBlock('adminhtml/catalog_product_attribute_edit','attribute_edit_content'));
        $this->getLayout()->getBlock('js')
            ->append($this->getLayout()->createBlock('core/template','catalog.wysiwyg.js')
